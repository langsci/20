...
\BackBody{%
So unterschiedlich die etablierten Syntaxmodelle auch sein mögen, sie alle haben gemeinsam, dass sie eng mit lexikalischen Valenzeigenschaften verzahnt sind: Valenztheoretisch fundierte Kategorien wie Valenzträger, Ergänzung und Angabe spielen in diesen Syntaxmodellen zentrale, klar differenzierte Rollen.
%%%
...
\include{02-valenz}
\include{03-kohaerenz}
\include{04-ellipse}    

\part{Syntax mit Valenz}
\include{05-tag}
\include{06-tag-kohaerenz}
\include{07-ttmctag-kohaerenz}  
\include{08-tag-ellipse}  

\part{Syntax ohne Valenz} 
\include{09-syntax-ohne-valenz}
